...
namespace Doppler.BillingUser.Test
{
    public class PostMercadoPagoNotificationTest : IClassFixture<WebApplicationFactory<Startup>>
    {
        ...
        [InlineData(MercadoPagoPaymentStatusEnum.ChargedBack, PaymentStatusEnum.Approved)]
        [InlineData(MercadoPagoPaymentStatusEnum.ChargedBack, PaymentStatusEnum.Pending)]
        ...
        [InlineData(MercadoPagoPaymentStatusEnum.InProcess, PaymentStatusEnum.Approved)]
        [InlineData(MercadoPagoPaymentStatusEnum.InProcess, PaymentStatusEnum.Pending)]
        [InlineData(MercadoPagoPaymentStatusEnum.InProcess, PaymentStatusEnum.DeclinedPaymentTransaction)]
        [InlineData(MercadoPagoPaymentStatusEnum.InMediation, PaymentStatusEnum.Approved)]
        [InlineData(MercadoPagoPaymentStatusEnum.InMediation, PaymentStatusEnum.Pending)]
        [InlineData(MercadoPagoPaymentStatusEnum.InMediation, PaymentStatusEnum.DeclinedPaymentTransaction)]
        ...
        [InlineData(MercadoPagoPaymentStatusEnum.ChargedBack, PaymentStatusEnum.DeclinedPaymentTransaction)]
